...
/**
 * System index: a quiet register of the eight disciplines set between two
...
export function CapabilityStrip() {
  const disciplines = capabilityStrip.slice(0, 8);
  return (
    <section aria-label="Capabilities" className="relative z-10 bg-white pt-8 md:pt-10">
      <div className="container-wol">
        ...
        <RevealGroup className="grid grid-cols-2 gap-x-6 gap-y-5 py-6 sm:grid-cols-4 md:py-7 lg:grid-cols-8" delay={0.2} step={0.05}>
